...
Status |	String |	Обязательный |	Статус платежа в случае успешного завершения: Completed — для [одностадийнх платежей](#shemy-provedeniya-platezha), Authorized — для [двухстадийных](#shemy-provedeniya-platezha)
...
Currency |	String |	Обязательный |	Валюта: RUB/USD/EUR/GBP из параметров виджета. (см. [справочник](#spisok-valyut))
RequireConfirmation |	Bool |	Обязательный |	Если значение `true` — платеж будет выполнен по [двустадийной схеме](#shemy-provedeniya-platezha)
...
Status |	String |	Обязательный |	[Статусы подписок](#statusy-podpisok-rekurrent)
...
Type |	Строка |	Обязательный |	Признак расчета, см. [справочник](#tipy-onlayn-chekov)
