...
* Необходимо менять ФН раз в год и хранить в течение 5-ти лет.
...
Мы используем кассы производства компании "Старрус", модели "РП Система 1ФС" и "РП Система 1ФА" с подключением к оператору фискальных данных ООО «ПЕТЕР-СЕРВИС Спецтехнологии» (ofd.ru).  

![starrys.jpg](images/starrys.jpg)

### Демонстрация технологии

Пример оплаты по карте с автоматическим формированием чека и отправкой на электронный адрес или телефон.

[пример оплаты и получение чека]()

### Стоимость

Стоимость услуг по онлайн-фискализации и сопровождению составляет 45300 рублей в год и складывается из стоимости онлайн-кассы — 3000 рублей в месяц, фискального накопителя — 6300 рублей в год и услуг оператора фискальных данных — 3000 рублей в год.
...
Данные для онлайн-чека можно передавать в [[параметры виджета]](), при [[оплате по криптограмме]]() или [[токену]](), при [[подтверждении оплаты]](), при [[проведении возврата]](), а также через специальное [[API кассы]]().

### Типы чеков и признак расчета

При передаче данных для онлайн-чека система формирует 2 типа чеков в автоматическом режиме:
...
Чек должен быть отправлен покупателю в момент расчета. Для [[одностадийных платежей]]() чек формируется сразу же после прохождения оплаты, для [[двустадийных]]() — при подтверждении операции.
